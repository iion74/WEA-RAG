...
def main():
    ...
    parser.add_argument("--pred_file", default="predictions/minicpm3-4b_rag_dev.jsonl")
    parser.add_argument("--metrics_file", default=None)
    parser.add_argument("--model", default=os.environ.get("MINICPM_MODEL", "openbmb/MiniCPM3-4B"))
